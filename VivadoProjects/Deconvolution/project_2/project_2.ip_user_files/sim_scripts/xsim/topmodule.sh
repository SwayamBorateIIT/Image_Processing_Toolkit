...
#
# Script generated by Vivado on Mon Apr 14 23:12:38 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : topmodule.sh
...
#
# Usage        : topmodule.sh
#                topmodule.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                topmodule.sh [-reset_run]
#                topmodule.sh [-reset_log]
#                topmodule.sh [-help]
#
...
# script info
echo -e "topmodule.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./topmodule.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot topmodule xil_defaultlib.topmodule xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim topmodule -key {Behavioral:sim_1:Functional:topmodule} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_9)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb topmodule.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./topmodule.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: topmodule.sh [-help]\n\
Usage: topmodule.sh [-step]\n\
Usage: topmodule.sh [-lib_map_path]\n\
Usage: topmodule.sh [-reset_run]\n\
Usage: topmodule.sh [-reset_log]\n\
Usage: topmodule.sh [-keep_index]\n\
Usage: topmodule.sh [-noclean_files]\n\n\
