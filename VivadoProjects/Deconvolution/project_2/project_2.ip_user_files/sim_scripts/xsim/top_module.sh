...
#
# Script generated by Vivado on Sun Apr 13 15:44:59 +0530 2025
...
#
# Usage        : top_module.sh
#                top_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_module.sh [-reset_run]
#                top_module.sh [-reset_log]
#                top_module.sh [-help]
#
...
# script info
echo -e "top_module.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_module xil_defaultlib.top_module xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_module -key {Behavioral:sim_1:Functional:top_module} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_module.wdb xsim.dir libdpi.so)
...
Usage: top_module.sh [-step]\n\
Usage: top_module.sh [-lib_map_path]\n\
Usage: top_module.sh [-reset_run]\n\
Usage: top_module.sh [-reset_log]\n\
Usage: top_module.sh [-keep_index]\n\
